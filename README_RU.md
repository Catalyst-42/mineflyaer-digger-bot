...
### Отладка  
prepare --> подготовка к копанию, бот подойдет на место линии, которую он должен выкопать  
lava --> принудительная проверка на рядом стоящую лаву / воду / воздух  
home --> отправить бота домой  
chest --> сложить лишние вещи в сундук, взять новые  
